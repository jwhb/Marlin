...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Ender 3 v2
    #define DEFAULT_Kp  32.26
    #define DEFAULT_Ki   2.99
    #define DEFAULT_Kd  87.10
    // M301 E0 P32.26 I2.99 D87.10
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 72.12
  #define DEFAULT_bedKi 13.07
  #define DEFAULT_bedKd 265.41
  // M304 P72.12 I13.07 D265.41
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -7.5, -0.6 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 252  // nozzle cleaner
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 32.5, 32.5, 32.5, 32.5 }  // (mm) Left, Front, Right, Back insets
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { 230, 0, 0 } }
  #define NOZZLE_CLEAN_END_POINT   { { 252, 0, 0 } }
  ...
  #define NOZZLE_CLEAN_MIN_TEMP 185
